...
%\newtheorem*{claim}{Claim}
	...
	\begin{lemma}
		...
		Moreover, this inclusion is dense. Hence beeing tempered is a propositionerty of distributions. %and can be checked by asking that for any $\phi \in \cS$ and any sequence $\phi_n \in \cD \subset \cS$ converging to $\phi$ in $\cS$, the limit $\lim_{n \to \infty} F(\phi_n)$ exists.
	\end{lemma}
